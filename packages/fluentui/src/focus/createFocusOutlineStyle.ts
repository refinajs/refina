...
import { shorthands, type GriffelStyle } from "@refina/griffel";
import {
...
export type FocusOutlineOffset = Record<
...
export interface CreateFocusOutlineStyleOptions
  extends Omit<CreateCustomFocusIndicatorStyleOptions, "enableOutline"> {
...
function getOutlinePosition(
  ...
  const offsetValue =
    (outlineOffset as FocusOutlineOffset)?.[position] || outlineOffset;
