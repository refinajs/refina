...
view((_) => {
  ...
  _.div(() => {
    ...
    _.div(() => {
      ...
      _.div(() => {
        ...
        _.$cls`mt-1 mb-4 block w-full px-3 py-[5px] bg-[#0d1117] outline-none rounded-[6px]
               border-2 border-[#21262d]
               focus-visible:border-2 focus-visible:border-[#2f81f7]`;
    ...
    _.div(() => {
      ...
      _._ul({}, () => {
        _.$cls`mr-4`;
        _._li({}, () => _.$cls`text-[#2f81f7]` && _.a("Terms", "/site/terms"));
        _.$cls`mr-4`;
        _._li(
          {},
          () => _.$cls`text-[#2f81f7]` && _.a("Privacy", "/site/privacy"),
        );
        _.$cls`mr-4`;
        _._li(
          {},
        ...
        _._li(
          {},
          () =>
            _.$cls`text-[#7d8590]` && _.a("Contact GitHub Support", "/contact"),
        );
      });
    });
  });
